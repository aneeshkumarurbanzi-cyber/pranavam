...
export default function Services({
  ...
  const items = (
    t.services.items as ReadonlyArray<{
      ic: string
      nm: string
      tg: string
      ds: string
  ...
  return (
    <section className="sec" id="services">
      <div className="s-bg">
        <img
          src="https://images.unsplash.com/photo-1697729444936-8c6a6f643312?w=1920&h=1080&fit=crop&q=85"
          alt=""
          aria-hidden="true"
          loading="lazy"
        />
