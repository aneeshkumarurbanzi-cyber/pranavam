        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex gap-5 mt-10">
            <a
              ...
              className="flex-1 h-14 rounded-xl font-semibold text-black flex items-center justify-center"
              style={{
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link href={`/products/${item.id}`}>
                  <button
                    className="w-full h-12 mt-6 rounded-xl text-black font-semibold"
                    style={{
                      background: "rgba(201,162,39,.4)",
                    }}
                  >
